...
DIA method variants (phospho) and instrument-specific settings are applied via `-c` config files.
...
The DIA-NN workflow is inherited from [quantms](https://github.com/bigbio/quantms).
