...
include { MSPROTEOMICS  } from './workflows/msproteomics'
...
include { getGenomeAttribute      } from './subworkflows/local/utils_nfcore_msproteomics_pipeline'
...
workflow NFCORE_MSPROTEOMICS {
    ...
    emit:
    multiqc_report = MSPROTEOMICS.out.multiqc_report // channel: /path/to/multiqc_report.html
}
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    RUN MAIN WORKFLOW
...
workflow {
    ...
    PIPELINE_COMPLETION (
        ...
        params.monochrome_logs,
        params.hook_url,
        NFCORE_MSPROTEOMICS.out.multiqc_report
    )
}
