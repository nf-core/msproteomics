...
INSTRUMENT_ONTOLOGY = {
    "ASC": "NT=Orbitrap Astral;AC=MS:1003378",
    "ASH": "NT=Orbitrap Astral;AC=MS:1003378",
    "FLX": "NT=Orbitrap Exploris 480;AC=MS:1003028",
    "SCP": "NT=Orbitrap Exploris 480;AC=MS:1003028",
    "STR": "NT=timsTOF;AC=MS:1003230",
}
...
def map_instrument(instrument_code):
    """Map instrument short code to MS ontology string."""
    if instrument_code in INSTRUMENT_ONTOLOGY:
        return INSTRUMENT_ONTOLOGY[instrument_code]
    return "NT=mass spectrometer;AC=MS:1000031"
    ...
    with open(output_path, "w", newline="") as f:
        ...
        for row in rows:
            ...
            sdrf_row = [
                ...
                map_instrument(instrument),                     # comment[instrument]
