process SAMPLESHEET_CHECK {
    ...
    def string_skip_sdrf_validation = validate_ontologies == false ? "--skip_sdrf_validation" : ""
    def string_skip_ms_validation = task.ext.skip_ms_validation == true ? "--skip_ms_validation" : ""
    def string_skip_factor_validation = task.ext.skip_factor_validation == true ? "--skip_factor_validation" : ""
    def string_skip_experimental_design_validation = task.ext.skip_experimental_design_validation == true ? "--skip_experimental_design_validation" : ""
    def string_use_ols_cache_only = task.ext.use_ols_cache_only == true ? "--use_ols_cache_only" : ""
    ...
    stub:
    """
    echo "Stub execution" > input_check.log
