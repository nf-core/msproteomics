//
// Subworkflow with functionality specific to the nf-preprocess-proteomics pipeline
//
...
include { completionEmail           } from '../utils_nfcore_pipeline/main'
include { completionSummary         } from '../utils_nfcore_pipeline/main'
include { imNotification            } from '../utils_nfcore_pipeline/main'
